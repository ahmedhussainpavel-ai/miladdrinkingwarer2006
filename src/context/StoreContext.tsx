    ...
    return [
      {
        ...
        items: [
          {
            ...
            name: '20L Pure Mineral Water Jar',
            volume: '20 Liters',
            quantity: 2,
            unitPrice: 80,
            jarDepositPaid: 0,
        ...
        deliveryZone: 'Gulshan & Banani Zone',
        ...
        assignedDriver: {
          ...
          vehicleNo: 'Dhaka Metro-Ta 11-4589'
        },
        ...
        items: [
          {
            ...
            name: 'Wireless Electric Jar Pump Dispenser',
            volume: 'Universal',
            quantity: 1,
            unitPrice: 450,
            jarDepositPaid: 0,
      ...
      },
      {
        ...
        customerName: 'FinTech Solutions Ltd (Nusrat)',
        customerPhone: '+880 1819-876543',
        customerEmail: 'admin@fintech.bd',
        type: 'subscription_delivery',
        items: [
          {
            productId: 'prod-20l-jar',
        ...
        totalAmount: 600,
        deliveryAddress: {
          id: 'addr-dhanmondi-corp',
          tag: 'Corporate Office',
          recipientName: 'Nusrat Jahan (Admin)',
          phone: '+880 1819-876543',
          addressLine: 'Level 4, House 12, Road 27',
          floorUnit: 'Finance Dept',
          area: 'Dhanmondi',
          city: 'Dhaka',
          postalCode: '1209',
          lat: 23.7509,
        ...
        deliveryDate: 'Today',
        timeSlot: 'Afternoon 02:00 PM - 05:00 PM',
        deliveryZone: 'Dhanmondi & Lalmatia Zone',
      ...
      },
      {
        ...
        customerName: 'Grand Sultan Convention',
        customerPhone: '+880 1912-334455',
        customerEmail: 'events@grandsultan.com',
        type: 'event_bulk',
        items: [
          {
            productId: 'prod-20l-jar',
        ...
        totalAmount: 1900,
        deliveryAddress: {
          id: 'addr-uttara-event',
          tag: 'Event Hall',
          recipientName: 'Convention Manager',
          phone: '+880 1912-334455',
          addressLine: 'Plot 7, Sector 3, Main Avenue',
          floorUnit: 'Banquet Floor',
          area: 'Uttara',
          city: 'Dhaka',
          postalCode: '1230',
          lat: 23.8759,
        ...
        timeSlot: 'Morning 08:00 AM - 11:00 AM',
        deliveryZone: 'Uttara & Airport Zone',
        paymentMethod: 'cod',
    ...
    return [
      {
        ...
        customerPhone: '+880 1712-345678',
        customerEmail: 'ahmedhussainpavel@gmail.com',
        planName: 'Family Hydration Plus (Weekly 2x)',
        frequency: 'weekly_2x',
        bottleSize: '20L',
        ...
        nextDeliveryDate: 'Thursday, Aug 28',
